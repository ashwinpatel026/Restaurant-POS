...
export default function EditDepartmentTypePage() {
  ...
  const fetchDepartmentType = async () => {
    try {
      ...
      const response = await fetch(`/api/master/department-type/${id}`, {
        headers: {
      ...
      if (response.ok) {
        ...
        toast.error("Error loading department type");
        router.push("/master/department/type");
      }
    } catch (error) {
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-2">
              Update department type information
            </p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg">
          <form onSubmit={handleSubmit}>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                      Enter a descriptive name for this department type
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="px-6 py-4 bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-600 rounded-b-lg flex justify-end space-x-3">
              ...
              >
                {loading ? "Updating..." : "Update Department Type"}
              </button>
            </div>
          </form>
        </div>
